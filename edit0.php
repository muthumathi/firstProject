      ...
      <div class="row">
				...
				<div class="row">
				  <div class="form-group col-sm-4">
					...
					<input type="text" name="languages_known" class="form-control" id="languages_known" required
							value="<?= $bo->languages_known ?>">
				  </div>
				  <div class="form-group col-sm-4">
					<label for="hobbies">Hobbies:</label>
					<input type="text" name="hobbies" class="form-control" id="hobbies" required
							value="<?= $bo->hobbies ?>">
				  </div>
        </div>
        <div class="row">
				  <div class="form-group col-sm-4">
					...
					<input type="text" name="sports" class="form-control" id="sports" required
							value="<?= $bo->sports ?>">
				  </div>
				  <div class="form-group col-sm-4">
					<label for="games">Games:</label>
					<input type="text" name="games" class="form-control" id="games" required
							value="<?= $bo->games ?>">
				  </div>
        </div>
        <div class="row">
				  ...
				  <div class="form-group col-sm-4">
					...
					<input type="text" name="goal_in_office" class="form-control" id="goal_in_office" required
							value="<?= $bo->goal_in_office ?>">
				  </div>
				</div>
